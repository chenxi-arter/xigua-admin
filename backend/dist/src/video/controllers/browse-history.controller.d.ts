...
export declare class BrowseHistoryController extends BaseController {
    ...
    getUserBrowseHistory(req: any, page?: string, size?: string, categoryId?: string): Promise<void | import("./base.controller").ApiResponse<null> | import("./base.controller").ApiResponse<{
        list: any[];
        total: number;
        page: number;
        size: number;
    ...
    getRecentBrowsedSeries(req: any, limit?: string): Promise<void | import("./base.controller").ApiResponse<any[]>>;
