...
export declare class RecommendService {
    ...
    constructor(episodeRepo: Repository<Episode>, episodeUrlRepo: Repository<EpisodeUrl>, cacheManager: Cache, episodeInteractionService: EpisodeInteractionService, favoriteService: FavoriteService);
