...
exports.BannerModule = BannerModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([banner_entity_1.Banner, banner_metric_daily_entity_1.BannerMetricDaily])],
        providers: [banner_service_1.BannerService],
        exports: [banner_service_1.BannerService, typeorm_1.TypeOrmModule],
    })
], BannerModule);
